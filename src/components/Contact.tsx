            ...
            <div className="mt-10 md:mt-10 lg:mt-20 max-w-5xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] px-6 py-4 md:py-8 gap-14 md:gap-20 lg:gap-0 xl:gap-40">
                    <div className="grid md:grid-rows-2 md:grid-cols-2 lg:grid-cols-1 justify-items-center lg:justify-items-start text-center gap-8 h-fit">
                        ...
                        <div className="flex flex-col lg:flex-row lg:text-left lg:gap-4 items-center group">
                            <div className="shrink-0 w-12 h-12 bg-background-contact rounded-2xl flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg">
                    ...
                    <AnimatedSection animation="fade-in-scale" delay={0.2} className="p-8 rounded-xl shadow-xl bg-background">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 bg-white border ${errors.nombre ? 'border-red-500' : 'border-gray-400'} rounded-lg focus:ring-emerald-600 focus:border-emerald-600 outline-none transition-all duration-300 focus:shadow-md`}
                                />
                                {errors.nombre && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 bg-white border ${errors.email ? 'border-red-500' : 'border-gray-400'} rounded-lg focus:ring-emerald-600 focus:border-emerald-600 outline-none transition-all duration-300 focus:shadow-md`}
                                />
                                {errors.email && (
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className={`w-full p-3 bg-white border ${errors.mensaje ? 'border-red-500' : 'border-gray-400'} rounded-lg resize-none focus:ring-emerald-600 focus:border-emerald-600 outline-none transition-all duration-300 focus:shadow-md`}
                                ></textarea>
                                {errors.mensaje && (
                            ...
                            <button
                                type="submit"
                                className="w-full cursor-pointer bg-color-primary text-white p-3 rounded-lg font-bold hover:bg-color-primary-hover hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex justify-center gap-1.5 items-center">
